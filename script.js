      ...
      Swal.fire("Awas aja kalo boong😒 nanti hidungnya panjang", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${nama} sayang gk sama ${sender}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${nama} Cinta gk sama ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Sama ${sender} juga Cinta ${nama} 🥰`).then(function () {
                          Swal.fire('Terakhir deh sayang').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('Jahat banget emang gk pernah cinta sama pacar sendiri, dahlah 😑', '', 'error').then(function () {
                          Swal.fire('Ywdah deh bye!')
                        })
                      }
                    })
                  })
              ...
              Swal.fire(`Yakin gk suka sama ${sender}?`, '', 'error').then(function () {
                Swal.fire('Ywdah deh bye!')
              })
            }
          })
